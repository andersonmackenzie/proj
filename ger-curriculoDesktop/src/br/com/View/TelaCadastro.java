...
public class TelaCadastro extends JInternalFrame implements ActionListener,
	...
	private static TelaCadastro singleton;
	...
	private TelaCadastro(String titulo, Menu telaPrincipal) {
	...
	// Errado refazer
	public static TelaCadastro getInstance(String titulo, Menu telaPrincipal) {
		if (singleton == null)
			return new TelaCadastro(titulo, telaPrincipal);
		else
			return singleton;
	}
