...
import br.com.tableModel.UniTableModel;

public class ListaUniver2 extends JInternalFrame implements ActionListener,
	...
	public ListaUniver2(String titulo, Menu telaPrincipal) {
	...
	private void modelaTela() {
		...
		table.setModel(new UniTableModel(new String[] { "Codigo", "Nome" },
				lista));
